...
public class CSSSelectors {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.className("input[id='username'")).sendKeys("victor");
		// id
		// #id
		// tagname#id
		// #username
...
//			select#Form_getForm_Country > option:nth-of-type(n+4)  -- start from 4th
//			select#Form_getForm_Country > option:nth-of-type(5n)  -- start from 5th and increment by 5
		...
		// 1. performance: good good --- xpath engines are fast all and depends on the
		// browser
