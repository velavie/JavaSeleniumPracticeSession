...
public class CascadedClassConcept {
	...
	public static void main(String[] args) {
		...
		// login-email")).sendKeys("naveen@gmail.com");

		// valid
		// driver.findElement(By.xpath("//input[@class='form-control
		// private-form__control login-email']")).sendKeys("test");
		...
		// valid
		driver.findElement(By.cssSelector("input.form-control.private-form__control.login-email"));// 3/3-diff order
