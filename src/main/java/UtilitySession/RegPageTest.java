...
//	}	
	...
	public static void main(String[] args) {
		...
		// By isSubscribeNo =
		// By.xpath("//*[@id=\"content\"]/form/fieldset[3]/div/div/label[2]/input");

		By policyChkBox = By.name("agree");
		By continueBtn = By.cssSelector("#content > form > div > div > input.btn.btn-primary");

		By successMessg = By.tagName("h1"); // success message

//		Execution		
		ElementUtil eleUtil = new ElementUtil(driver);
		eleUtil.doSendKeys(fName, "victor");
		eleUtil.doSendKeys(lName, "automation");
		// eleUtil.doSendKeys(eMail, "secures@gmail.com");
		eleUtil.doSendKeys(eMail, StringUtils.getRandomEmail()); // check StringUtils class
		...
		String actSuccMessg = eleUtil.doGetElementText(successMessg); // capture Success Message
