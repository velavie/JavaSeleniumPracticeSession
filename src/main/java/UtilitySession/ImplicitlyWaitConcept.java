...
//		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(0));//sel 4.x
		...
		// login page: 0 secs: WILL REQUIRE CONTINOUOS OVERRIDES timeout values

		// case 2: GLOBAL WAIT - APPLIES TO ALL Elements - cannot apply to a specific
		// element only
		// login page: 10 secs
		// e1 : 10
		// e2 : 10
		...
		// ****avoid imp wait in your real time frameWork****
